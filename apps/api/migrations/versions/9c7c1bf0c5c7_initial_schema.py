...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_finding_verifications_finding_id"),
        "finding_verifications",
        ["finding_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_report_findings_finding_id"), "report_findings", ["finding_id"], unique=False
    )
    op.create_index(
        op.f("ix_report_findings_report_id"), "report_findings", ["report_id"], unique=False
    )
    op.create_table(
        "runs",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_scope_rules_engagement_id"), "scope_rules", ["engagement_id"], unique=False
    )
    op.create_table(
        "approval_requests",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_evidence_artifacts_engagement_id"),
        "evidence_artifacts",
        ["engagement_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_evidence_artifacts_project_id"), "evidence_artifacts", ["project_id"], unique=False
    )
    op.create_index(
        op.f("ix_evidence_artifacts_run_id"), "evidence_artifacts", ["run_id"], unique=False
    )
    op.create_index(
        op.f("ix_evidence_artifacts_run_step_id"),
        "evidence_artifacts",
        ["run_step_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_evidence_relations_source_id"), "evidence_relations", ["source_id"], unique=False
    )
    op.create_index(
        op.f("ix_evidence_relations_target_id"), "evidence_relations", ["target_id"], unique=False
    )
