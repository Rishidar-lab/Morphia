...
function ApprovalCard({ run, projectName }: { run: Run; projectName: string }) {
  ...
  return (
    <>
      <div className="bg-[var(--bg-panel)] border border-[var(--border-default)] rounded-[6px] p-4 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <button
            ...
            className="px-3 py-1.5 text-xs font-medium rounded-md bg-[var(--pass)] hover:bg-green-500 text-white transition-colors"
          >
            Approve
          </button>
          <button
